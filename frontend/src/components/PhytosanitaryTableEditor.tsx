      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between pb-3 mb-4 border-b border-[#EBE9E1] gap-2">
        ...
        <div className="flex items-center space-x-2">
          <select
            ...
            className="text-xs font-bold text-[#344E41] bg-[#F9F8F5] border border-[#EBE9E1] rounded-lg px-3 py-2 cursor-pointer shadow-sm hover:border-[#A3B18A] hover:bg-[#F0F2E9] focus:bg-white focus:border-[#A3B18A] focus:ring-2 focus:ring-[#E9EDC9] focus:outline-none transition-all w-48"
          >
